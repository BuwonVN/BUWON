        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TodayTask = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TomorrowTask = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DepartmentId = table.Column<int>(type: "int", nullable: false)
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "c02300d8-37ea-4197-88d9-1a06b99341e0", "Administrator", "admin", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "e66b297a-a7ae-4c81-9b4d-d70752700a68", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "orib@a2-cloud.com", true, "Hien", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Bui", false, null, "ORIB@A2-CLOUD.COM", "ADMIN", "AQAAAAEAACcQAAAAEHJAAe9Z+pYXKXjRlDVxC9mNjDb3RDd+OhQ0+Nj+SuXyrGrbhsvHP9NDq+pnihqZKg==", null, false, "3db4eb26-5aa4-49b3-a4c1-9772cbd7ec0e", false, "admin", false });
